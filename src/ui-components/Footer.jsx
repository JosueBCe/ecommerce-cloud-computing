  ...
  return (
    ...
    >
      <View
        ...
        right="0%"
        padding="0px 0px 0px 0px"
        backgroundColor="rgba(12,58,64,1)"
      ...
      >
        ...
        >
          <Text
            ...
            {...getOverrideProps(
              overrides,
              "Lorem ipsum dolor sit amet34603031"
            )}
          ></Text>
          <Text
            fontFamily="Inter"
            ...
            {...getOverrideProps(overrides, "Consectetur adipiscing34603032")}
          ></Text>
          <Text
            fontFamily="Inter"
            fontSize="16px"
            ...
            {...getOverrideProps(overrides, "Elit sed do eiusmod34603033")}
          ></Text>
          <Text
            fontFamily="Inter"
            fontSize="16px"
        ...
        >
          <Text
            ...
            {...getOverrideProps(
              overrides,
              "Lorem ipsum dolor sit amet34603037"
            )}
          ></Text>
          <Text
            fontFamily="Inter"
            ...
            whiteSpace="pre-wrap"
            children="Consectetur adipiscing"
            {...getOverrideProps(overrides, "Consectetur adipiscing34603038")}
          ></Text>
          <Text
            fontFamily="Inter"
            fontSize="16px"
            ...
            whiteSpace="pre-wrap"
            children="Elit sed do eiusmod"
            {...getOverrideProps(overrides, "Elit sed do eiusmod34603039")}
          ></Text>
        </Flex>
      </Flex>
      <Text
      ...
      <Flex
        ...
        left="1506px"
        padding="0px 0px 0px 0px"
        {...getOverrideProps(overrides, "Logo34603045")}
      >
        <Icon
          width="18px"
          height="18px"
        ...
        <Text
          ...
          whiteSpace="pre-wrap"
          children="Logo"
          {...getOverrideProps(overrides, "Logo34603047")}
        ></Text>
      </Flex>
    </View>
  );
